...
"C:\Users\Admin\AppData\Local\Programs\Python\Python311\python.exe" -u firebase_face_recognition_listener.py --camera 0 --threshold 70 --standalone --cooldown 5 --discord-webhook "%DISCORD_WEBHOOK_URL%" --notify-known
pause
goto menu
